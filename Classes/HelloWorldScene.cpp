...
bool res = HelloWorld::lbl->mLbc->opRaiseEvent(false, 1, 0);
//int res = HelloWorld::lbl->mLbc->getCountPlayersOnline();
 //int res = HelloWorld::lbl->mLbc->o
cocos2d::log("GRINLOG:Touch %d", res ? 1:0);
...
void HelloWorld::setPeer(ExitGames::Lite::LitePeer *new_peer) {
	this->peer = new_peer;
}
